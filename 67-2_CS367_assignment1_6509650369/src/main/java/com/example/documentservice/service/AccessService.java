...
public class AccessService {
    ...
    public ServiceResponseDto requestAccess(RequestAccessDto dto) {
        Optional<User> requester = userRepository.findById(dto.getRequesterId()); // Changed to use getter
        Optional<User> provider = userRepository.findById(dto.getProviderId()); // Changed to use getter
